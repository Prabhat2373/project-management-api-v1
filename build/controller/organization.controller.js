...
exports.registerOrganization = (0, catchAsyncErrors_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newOrganization;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, organization_model_1.default.create(req.body)];
            case 1:
                newOrganization = _a.sent();
                res.status(AppConstant_1.Api.CREATED).json({
                    status: AppConstant_1.Api.CREATED,
                    message: (0, ApiResponses_1.Created)('Organization'),
